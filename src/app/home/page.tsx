...
export default function HomePage() {
  ...
  if (!session?.user) {
    return (
      <main className="page-container min-h-screen flex flex-col items-center justify-center text-center space-y-6">
  ...
  return (
    <main className="page-container min-h-screen bg-background text-foreground space-y-10 pt-8 pb-20">
